...
With prefix argument N, slurp that many sexps.  Negative argument
means slurp backward."
  (interactive "p")
  (setq n (or n 1))
  (if (< n 0) (puni-slurp-backward (- n))
    (dotimes (_ n)
...
With prefix argument N, barf that many sexps.  Negative argument
means barf backward."
  (interactive "p")
  (setq n (or n 1))
  (if (< n 0) (puni-barf-backward (- n))
    (dotimes (_ n)
      (when-let* ((beg-of-delim (puni-end-pos-of-list-around-point))
                  (end-of-delim (puni-end-pos-of-sexp-around-point))
