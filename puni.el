...
(defvar puni-mode-map
  (let ((map (make-sparse-keymap)))
    ...
    (define-key map [remap delete-char] 'puni-forward-delete-char)
    (define-key map [remap delete-forward-char] 'puni-forward-delete-char)
    (define-key map [remap kill-word] 'puni-forward-kill-word)
    (define-key map [remap backward-kill-word] 'puni-backward-kill-word)
    ...
    (define-key map [remap kill-region] 'puni-kill-active-region)
    (define-key map [remap forward-sexp] 'puni-forward-sexp)
    (define-key map [remap backward-sexp] 'puni-backward-sexp)
    (define-key map [remap beginning-of-sexp] 'puni-beginning-of-sexp)
    (define-key map [remap end-of-sexp] 'puni-end-of-sexp)
